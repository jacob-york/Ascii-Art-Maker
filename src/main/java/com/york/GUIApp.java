...
public class GUIApp extends Application {
	...
	public static final String MAIN_PATH = "D:\\Programming\\Projects\\JavaProjects\\Personal\\AsciiArtMaker\\src\\main";
	...
	public void start(Stage stage) {
		...
		Image icon = new Image(MAIN_PATH + "\\resources\\com\\example\\images\\icon.png");
		...
		render.setOnAction(new EventHandler<ActionEvent>(){
			...
			public void handle(ActionEvent ae) {
				...
				if (curImagePath != null) {
					...
					try {
						ConsoleApp.writeToOutput(art, outPath, asciiImage.getName());
					} catch (IOException e) {
